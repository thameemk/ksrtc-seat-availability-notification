!function (e, t) {
    ...
    C.fn = C.prototype = {
        ...
        for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || y(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in e) n = s[t], s !== (i = e[t]) && (u && i && (C.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1, o = n && Array.isArray(n) ? n : []) : o = n && C.isPlainObject(n) ? n : {}, s[t] = C.extend(u, o, i)) : void 0 !== i && (s[t] = i));
        return s
    }, C.extend({
    ...
    var B = function (e, t, n, i, r, o, s) {
        ...
        if ("object" === w(n)) for (a in r = !0, n) B(e, t, a, n[a], !0, o, s); else if (void 0 !== i && (r = !0, y(i) || (s = !0), u && (s ? (t.call(e, i), t = null) : (u = t, t = function (e, t, n) {
            return u.call(C(e), n)
    ...
    var n = "alert", r = "bs.alert", o = "." + r, a = p.fn[n],
        u = {CLOSE: "close" + o, CLOSED: "closed" + o, CLICK_DATA_API: "click" + o + ".data-api"}, c = function () {
            function i(e) {
                this._element = e
            }
    ...
    var f = "button", h = "bs.button", d = "." + h, m = ".data-api", v = p.fn[f], y = "active",
        _ = '[data-toggle^="button"]',
        b = {CLICK_DATA_API: "click" + d + m, FOCUS_BLUR_DATA_API: "focus" + d + m + " blur" + d + m}, w = function () {
            function n(e) {
                this._element = e
            }
    ...
    var E = "carousel", T = "bs.carousel", x = "." + T, C = ".data-api", S = p.fn[E],
        D = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, A = {
        ...
        }, O = "active", L = ".active.carousel-item", j = {TOUCH: "touch", PEN: "pen"}, H = function () {
            function o(e, t) {
            ...
            return e.next = function () {
                ...
                if (!(e > this._items.length - 1 || e < 0)) if (this._isSliding) p(this._element).one(k.SLID, function () {
                    return t.to(e)
                }); else {
                ...
                var n = this._getItemIndex(e), i = this._getItemIndex(this._element.querySelector(L)),
                ...
                var n, i, r, o = this, s = this._element.querySelector(L), a = this._getItemIndex(s),
                    l = t || s && this._getItemByDirection(e, s), u = this._getItemIndex(l), c = Boolean(this._interval);
                if (r = e === N ? (n = "carousel-item-left", i = "carousel-item-next", "left") : (n = "carousel-item-right", i = "carousel-item-prev", "right"), l && p(l).hasClass(O)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
                    this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(l);
                    var f = p.Event(k.SLID, {relatedTarget: l, direction: r, from: a, to: u});
                ...
                return this.each(function () {
                    var e = p(this).data(T), t = l({}, D, p(this).data());
                    "object" == typeof i && (t = l({}, t, i));
                    var n = "string" == typeof i ? i : t.slide;
                    if (e || (e = new o(this, t), p(this).data(T, e)), "number" == typeof i) e.to(i); else if ("string" == typeof n) {
    ...
    var P = "collapse", q = "bs.collapse", R = "." + q, M = p.fn[P], F = {toggle: !0, parent: ""},
        W = {toggle: "boolean", parent: "(string|element)"}, B = {
            SHOW: "show" + R,
            SHOWN: "shown" + R,
            HIDE: "hide" + R,
            HIDDEN: "hidden" + R,
            CLICK_DATA_API: "click" + R + ".data-api"
        }, U = "show", K = "collapse", $ = "collapsing", Q = "collapsed", V = '[data-toggle="collapse"]', z = function () {
            function a(t, e) {
            ...
            return e.toggle = function () {
                ...
                return this.each(function () {
                    var e = p(this), t = e.data(q), n = l({}, F, e.data(), "object" == typeof i && i ? i : {});
    ...
    p(document).on(B.CLICK_DATA_API, V, function (e) {
        ...
        p(i).each(function () {
            var e = p(this), t = e.data(q) ? "toggle" : n.data();
    ...
    for (var Y = "undefined" != typeof window && "undefined" != typeof document, X = ["Edge", "Trident", "Firefox"], G = 0, J = 0; J < X.length; J += 1) if (Y && 0 <= navigator.userAgent.indexOf(X[J])) {
        G = 1;
        break
    }
    ...
    function de(e) {
        var t = e.body, n = e.documentElement, i = se(10) && getComputedStyle(n);
    ...
    function ye(e) {
        ...
        try {
            if (se(10)) {
                ...
                var n = ce(e, "top"), i = ce(e, "left");
                t.top += n, t.left += i, t.bottom += n, t.right += i
            } else t = e.getBoundingClientRect()
        } catch (e) {
        }
        var r = {left: t.left, top: t.top, width: t.right - t.left, height: t.bottom - t.top},
            o = "HTML" === e.nodeName ? de(e.ownerDocument) : {}, s = o.width || e.clientWidth || r.right - r.left,
    ...
    function _e(e, t) {
        var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = se(10), r = "HTML" === t.nodeName,
            o = ye(e), s = ye(t), a = ie(e), l = te(t), u = parseFloat(l.borderTopWidth, 10),
            c = parseFloat(l.borderLeftWidth, 10);
        n && r && (s.top = Math.max(s.top, 0), s.left = Math.max(s.left, 0));
        var f = ve({top: o.top - s.top - u, left: o.left - s.left - c, width: o.width, height: o.height});
        ...
        return (i && !n ? t.contains(a) : t === a && "BODY" !== a.nodeName) && (f = function (e, t) {
            var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = ce(t, "top"),
                r = ce(t, "left"), o = n ? -1 : 1;
    ...
    function we(e, t, n, i) {
        ...
        if ("viewport" === i) o = function (e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                n = e.ownerDocument.documentElement, i = _e(e, n), r = Math.max(n.clientWidth, window.innerWidth || 0),
                o = Math.max(n.clientHeight, window.innerHeight || 0), s = t ? 0 : ce(n), a = t ? 0 : ce(n, "left");
            ...
            if ("HTML" !== a.nodeName || function e(t) {
                ...
                var u = de(e.ownerDocument), c = u.height, f = u.width;
    ...
    function Se(e, t, n) {
        n = n.split("-")[0];
        var i = xe(e), r = {width: i.width, height: i.height}, o = -1 !== ["right", "left"].indexOf(n),
    ...
    function Re(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], n = qe.indexOf(e),
            ...
            shift: {
                ...
                order: 500, enabled: !0, fn: function (e, t) {
                    ...
                    var r = e.placement.split("-")[0], o = e.offsets, s = o.popper, a = o.reference,
                        ...
                        f = c.toLowerCase(), h = l ? "left" : "top", d = l ? "bottom" : "right", p = xe(i)[u];
                ...
                order: 600, enabled: !0, fn: function (p, g) {
                    ...
                    var m = we(p.instance.popper, p.instance.reference, g.padding, g.boundariesElement, p.positionFixed),
                        v = p.placement.split("-")[0], y = Ce(v), _ = p.placement.split("-")[1] || "", b = [];
                    switch (g.behavior) {
                        case"flip":
                            b = [v, y];
                            break;
                ...
                order: 800, enabled: !0, fn: function (e) {
                    ...
                    var t = e.offsets.reference, n = De(e.instance.modifiers, function (e) {
                ...
                order: 850, enabled: !0, fn: function (e, t) {
                    var n = t.x, i = t.y, r = e.offsets.popper, o = De(e.instance.modifiers, function (e) {
                        return "applyStyle" === e.name
                    }).gpuAcceleration;
                    void 0 !== o && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var s, a, l, u, c, f, h, d, p, g, m, v, y, _, b, w, E = void 0 !== o ? o : t.gpuAcceleration,
                        T = ae(e.instance.popper), x = ye(T), C = {position: r.position},
                        S = (s = e, a = window.devicePixelRatio < 2 || !je, u = (l = s.offsets).popper, c = l.reference, f = Math.round, h = Math.floor, d = function (e) {
                            ...
                            bottom: _(u.bottom),
                            right: y(u.right)
                        }), D = "bottom" === n ? "top" : "bottom", A = "right" === i ? "left" : "right",
                        N = Ie("transform");
                    if (w = "bottom" === D ? "HTML" === T.nodeName ? -T.clientHeight + S.bottom : -x.height + S.bottom : S.top, b = "right" === A ? "HTML" === T.nodeName ? -T.clientWidth + S.right : -x.width + S.right : S.left, E && N) C[N] = "translate3d(" + b + "px, " + w + "px, 0)", C[D] = 0, C[A] = 0, C.willChange = "transform"; else {
                        var I = "bottom" === D ? -1 : 1, k = "right" === A ? -1 : 1;
    ...
    var We = "dropdown", Be = "bs.dropdown", Ue = "." + Be, Ke = ".data-api", $e = p.fn[We],
        Qe = new RegExp("38|40|27"), Ve = {
            HIDE: "hide" + Ue,
            HIDDEN: "hidden" + Ue,
            SHOW: "show" + Ue,
            SHOWN: "shown" + Ue,
        ...
        }, ze = "disabled", Ye = "show", Xe = "dropdown-menu-right", Ge = '[data-toggle="dropdown"]', Je = ".dropdown-menu",
        Ze = {offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic"}, et = {
            ...
            return e.toggle = function () {
                if (!this._element.disabled && !p(this._element).hasClass(ze)) {
                    var e = u._getParentFromElement(this._element), t = p(this._menu).hasClass(Ye);
                    if (u._clearMenus(), !t) {
                        var n = {relatedTarget: this._element}, i = p.Event(Ve.SHOW, n);
                ...
                if (!(this._element.disabled || p(this._element).hasClass(ze) || p(this._menu).hasClass(Ye))) {
                    var e = {relatedTarget: this._element}, t = p.Event(Ve.SHOW, e),
                ...
                if (!this._element.disabled && !p(this._element).hasClass(ze) && p(this._menu).hasClass(Ye)) {
                    var e = {relatedTarget: this._element}, t = p.Event(Ve.HIDE, e),
                        n = u._getParentFromElement(this._element);
                ...
                if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which)) for (var t = [].slice.call(document.querySelectorAll(Ge)), n = 0, i = t.length; n < i; n++) {
                    var r = u._getParentFromElement(t[n]), o = p(t[n]).data(Be), s = {relatedTarget: t[n]};
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(Je).length)) : Qe.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(ze))) {
                    var t = u._getParentFromElement(this), n = p(t).hasClass(Ye);
    ...
    var nt = "modal", it = "bs.modal", rt = "." + it, ot = p.fn[nt],
        st = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        at = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, lt = {
            HIDE: "hide" + rt,
            HIDDEN: "hidden" + rt,
            SHOW: "show" + rt,
            SHOWN: "shown" + rt,
        ...
        }, ut = "modal-open", ct = "fade", ft = "show", ht = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
        dt = ".sticky-top", pt = function () {
            function r(e, t) {
            ...
            return e.toggle = function (e) {
                ...
                var t = this, n = p(this._element).hasClass(ct);
                ...
                var i = p.Event(lt.SHOWN, {relatedTarget: e}), r = function () {
                ...
                var t = this, n = p(this._element).hasClass(ct) ? ct : "";
                ...
                if (this._isBodyOverflowing) {
                    var e = [].slice.call(document.querySelectorAll(ht)), t = [].slice.call(document.querySelectorAll(dt));
                ...
                return this.each(function () {
                    var e = p(this).data(it), t = l({}, st, p(this).data(), "object" == typeof n && n ? n : {});
    ...
    var _t = "tooltip", bt = "bs.tooltip", wt = "." + bt, Et = p.fn[_t], Tt = "bs-tooltip",
        xt = new RegExp("(^|\\s)" + Tt + "\\S+", "g"), Ct = ["sanitize", "whiteList", "sanitizeFn"], St = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object"
        }, Dt = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, At = {
            animation: !0,
        ...
        }, kt = "fade", Ot = "show", Lt = "hover", jt = "focus", Ht = function () {
            function i(e, t) {
            ...
            return e.enable = function () {
                ...
                var e = p(this.getTipElement()), t = e.attr("class").match(xt);
                ...
                return this.each(function () {
                    var e = p(this).data(bt), t = "object" == typeof n && n;
    ...
    var Pt = "popover", qt = "bs.popover", Rt = "." + qt, Mt = p.fn[Pt], Ft = "bs-popover",
        Wt = new RegExp("(^|\\s)" + Ft + "\\S+", "g"), Bt = l({}, Ht.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), Ut = l({}, Ht.DefaultType, {content: "(string|element|function)"}), Kt = {
            HIDE: "hide" + Rt,
            HIDDEN: "hidden" + Rt,
            SHOW: "show" + Rt,
            SHOWN: "shown" + Rt,
            ...
            return r.isWithContent = function () {
                ...
                var e = p(this.getTipElement()), t = e.attr("class").match(Wt);
                null !== t && 0 < t.length && e.removeClass(t.join(""))
            }, i._jQueryInterface = function (n) {
                return this.each(function () {
                    var e = p(this).data(qt), t = "object" == typeof n ? n : null;
    ...
    var Qt = "scrollspy", Vt = "bs.scrollspy", zt = "." + Vt, Yt = p.fn[Qt],
        Xt = {offset: 10, method: "auto", target: ""},
        Gt = {offset: "number", method: "string", target: "(string|element)"},
        Jt = {ACTIVATE: "activate" + zt, SCROLL: "scroll" + zt, LOAD_DATA_API: "load" + zt + ".data-api"},
        Zt = "active", en = ".nav, .list-group", tn = ".nav-link", nn = ".list-group-item", rn = "position",
        on = function () {
            function n(e, t) {
                var n = this;
            ...
            return e.refresh = function () {
                var t = this, e = this._scrollElement === this._scrollElement.window ? "offset" : rn,
                ...
                n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(Zt), n.addClass(Zt)) : (n.addClass(Zt), n.parents(en).prev(tn + ", " + nn).addClass(Zt), n.parents(en).prev(".nav-item").children(tn).addClass(Zt)), p(this._scrollElement).trigger(Jt.ACTIVATE, {relatedTarget: t})
            }, e._clear = function () {
    ...
    var sn = "bs.tab", an = "." + sn, ln = p.fn.tab, un = {
        HIDE: "hide" + an,
        HIDDEN: "hidden" + an,
        SHOW: "show" + an,
        SHOWN: "shown" + an,
        CLICK_DATA_API: "click" + an + ".data-api"
    }, cn = "active", fn = ".active", hn = "> li > .active", dn = function () {
        function i(e) {
            this._element = e
        }
        ...
        return e.show = function () {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(cn) || p(this._element).hasClass("disabled"))) {
                ...
                var s = p.Event(un.HIDE, {relatedTarget: this._element}), a = p.Event(un.SHOW, {relatedTarget: i});
            ...
            var i = this, r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(fn) : p(t).find(hn))[0],
                o = n && r && p(r).hasClass("fade"), s = function () {
    ...
    var pn = "toast", gn = "bs.toast", mn = "." + gn, vn = p.fn[pn], yn = {
            CLICK_DISMISS: "click.dismiss" + mn,
            HIDE: "hide" + mn,
            HIDDEN: "hidden" + mn,
            SHOW: "show" + mn,
            SHOWN: "shown" + mn
        }, _n = "show", bn = "showing", wn = {animation: "boolean", autohide: "boolean", delay: "number"},
        En = {animation: !0, autohide: !0, delay: 500}, Tn = function () {
            function i(e, t) {
    ...
    }(), e.Util = g, e.Alert = c, e.Button = w, e.Carousel = H, e.Collapse = z, e.Dropdown = tt, e.Modal = pt, e.Popover = $t, e.Scrollspy = on, e.Tab = dn, e.Toast = Tn, e.Tooltip = Ht, Object.defineProperty(e, "__esModule", {value: !0})
});